...
export default {
  ...
  taller: {
    ...
    ideas: [
      ...
      { titulo: 'Algo de tu propio hobby o interés', contexto: 'Un rastreador de entrenamientos, un catálogo de tu colección, una herramienta para un juego que te guste: si te apasiona, la vas a entender mejor que cualquier caso que te den.' },
    ],
    campos: [
