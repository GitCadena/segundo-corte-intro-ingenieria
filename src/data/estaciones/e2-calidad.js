...
export default {
  ...
  taller: {
    ...
    nivel: 'base',
    puntos: 0,
    titulo: 'Taller en clase · Auditoría de una app conocida',
    objetivo: 'Aplicar la lista de chequeo de calidad a una aplicación que el grupo use a diario.',
    instrucciones:
      'En grupos de tres. Elijan una app que todos usen. El entregable no lo califica esta aplicación.',
    conceptoPrevio: 'Toda la estación.',
    enunciado:
      'Auditen una aplicación de uso cotidiano con la lista de chequeo y propongan dos mejoras justificadas con la característica de calidad que atacan.',
    temas: [
      'La plataforma académica de Unimayor.',
      'La app del banco que usen.',
      'Una app de transporte o domicilios.',
      'El sistema de la biblioteca.',
      'Una red social, tomando una sola tarea concreta.',
      'La app de su EPS.',
    ],
    campos: [
      { id: 'app', etiqueta: 'Aplicación auditada y tarea concreta elegida', filas: 2 },
      { id: 'exito', etiqueta: 'Criterio de éxito de la tarea, definido ANTES de probar', filas: 2 },
      { id: 'hallazgos', etiqueta: 'Hallazgos: qué observaron y qué característica de ISO/IEC 25010 afecta cada uno', filas: 5 },
      { id: 'mejora1', etiqueta: 'Mejora 1: qué cambiarían, qué característica ataca y cómo comprobarían que sirvió', filas: 3 },
      { id: 'mejora2', etiqueta: 'Mejora 2: igual que la anterior', filas: 3 },
    ],
    listaChequeo: [
      '¿La tarea principal se puede completar sin ayuda externa?',
      '¿Los mensajes de error dicen qué campo corregir y qué se espera?',
      '¿Se pierde el trabajo del usuario cuando algo falla?',
      '¿La información de error se transmite solo con color?',
      '¿Se puede operar completamente con el teclado?',
      '¿La app funciona con conexión intermitente?',
      '¿Pide datos personales que no necesita para la tarea?',
      '¿El tiempo de respuesta es aceptable en la franja de mayor uso?',
    ],
    rubrica: [
      'Cada hallazgo nombra la característica de calidad afectada y describe la conducta observada, no una impresión. (40 %)',
      'El criterio de éxito se definió antes de probar y no se ajustó después. (20 %)',
      'Cada mejora propone cómo se comprobaría que funcionó, con una medida concreta. (40 %)',
    ],
  },
}
